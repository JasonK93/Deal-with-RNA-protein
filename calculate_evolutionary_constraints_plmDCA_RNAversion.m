...
function calculate_evolutionary_constraints_plmDCA_RNAversion(msa_fasta_filename, seqid_of_interest, outputfile)
% usage: calculate_evolutionary_constraints_plmDCA_RNAversion('RF00167.afa.txt', '1Y26', '1y26_MI_DI.txt')
